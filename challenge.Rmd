...
author: "Pablo Aísa, Irene Bosque, Mafalda González and David Pereiro"
...
## Other variables related to transgender people
...
These two graphs show the distributions from 1-10 grouped by country for the questions on how respondents feel if a transgender person reaches the highest political position in their country and how they would feel if one of their children is in love with a transgender person. 

These graphs show that the distribution of countries is similar to that initially presented for the dependent variable. The countries that are most supportive of transgender people do so for all variables, not only for the change of official documents.
...
The next model includes additional predictors like female, occupation, and religion interactions with religiosity_percent, along with other interaction terms such as contact_lgbti with rain index and ideology with GDP per capita. We also kept the random slopes for age, female, and ideology across countries, as these allow the effects of these variables to vary by country.
