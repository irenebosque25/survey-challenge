...
ggplot(data_descriptive, aes(x = gdp_pc, y = rain_ind, label = isocntry)) +
  ...
  geom_text(size = 3, hjust = -0.6) +  # Ajusta el texto a la derecha
...
data_country <- aggregate(as.numeric(trans_name) ~ isocntry, data = data_descriptive, mean, na.rm = TRUE)
...
```{r}
ggplot(data_descriptive, aes(x = as.factor(trans_name), y = ideology, fill = as.factor(trans_name))) + 
...
```{r}
ggplot(data_descriptive, aes(x = as.factor(trans_name), y = religiosity_percent, fill = as.factor(trans_name))) +
  geom_boxplot(alpha = 0.6) +
  theme_minimal() +
...
```{r}
model <- glm(trans_name ~ scale(age) + 
               female + 
               religion + 
               occupation + 
               marital_status + 
...
## Training with group_by(countries) 
...
Formula: trans_name ~ scale(age) + I(scale(age)^2) + female + occupation +  
    ...
    scale(gdp_pc) + (1 + scale(age) + female + scale(ideology) |  
    isocntry)
   Data: training
...
-7.7042 -0.7378  0.3432  0.6528  4.5986 
...
occupationStudent                                      0.29905    0.10137
occupationUnemployed                                   0.03343    0.06729
religionMuslims                                       -0.43853    0.16409
religionNot religious                                  0.38864    0.05693
religionOrthodox Chrsitian                            -0.05508    0.08798
religionOther religions                               -0.09002    0.09448
scale(religiosity_percent)                            -0.19284    0.09160
personal_satisSatisfied                                0.35552    0.05257
contact_lgbtiContact                                   0.89728    0.04253
scale(rain_ind)                                        0.19638    0.11174
self_determination1                                    0.44637    0.23033
scale(ideology)                                       -0.20122    0.03209
scale(gdp_pc)                                          0.25266    0.10800
religionMuslims:scale(religiosity_percent)            -0.31704    0.27033
...
religionOther religions:scale(religiosity_percent)    -0.21164    0.07232
contact_lgbtiContact:scale(rain_ind)                   0.06766    0.04361
scale(ideology):scale(gdp_pc)                         -0.11946    0.03368
                                                      z value Pr(>|z|)    
(Intercept)                                            -4.072 4.65e-05 ***
scale(age)                                             -0.553 0.580199    
I(scale(age)^2)                                        -2.893 0.003810 ** 
female1                                                 7.135 9.69e-13 ***
occupationRetired                                      -3.577 0.000347 ***
occupationSelf employed                                 2.039 0.041407 *  
occupationStudent                                       2.950 0.003176 ** 
occupationUnemployed                                    0.497 0.619276    
religionMuslims                                        -2.672 0.007530 ** 
religionNot religious                                   6.827 8.69e-12 ***
religionOrthodox Chrsitian                             -0.626 0.531312    
religionOther religions                                -0.953 0.340727    
scale(religiosity_percent)                             -2.105 0.035261 *  
personal_satisSatisfied                                 6.763 1.35e-11 ***
contact_lgbtiContact                                   21.098  < 2e-16 ***
scale(rain_ind)                                         1.758 0.078830 .  
self_determination1                                     1.938 0.052627 .  
scale(ideology)                                        -6.270 3.61e-10 ***
scale(gdp_pc)                                           2.339 0.019312 *  
religionMuslims:scale(religiosity_percent)             -1.173 0.240881    
religionNot religious:scale(religiosity_percent)        1.506 0.132060    
religionOrthodox Chrsitian:scale(religiosity_percent)   2.774 0.005530 ** 
religionOther religions:scale(religiosity_percent)     -2.927 0.003426 ** 
contact_lgbtiContact:scale(rain_ind)                    1.551 0.120837    
...
Control: glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 1e+05))
     ...
     AIC      BIC   logLik deviance df.resid 
 18281.3  18551.9  -9105.6  18211.3    16806 

Scaled residuals: 
    Min      1Q  Median      3Q     Max 
-7.6508 -0.7384  0.3428  0.6549  5.3266 

Random effects:
 Groups   Name            Variance Std.Dev. Corr             
 isocntry (Intercept)     0.24961  0.4996                    
          scale(age)      0.03550  0.1884   -0.21            
          female1         0.04647  0.2156    0.57  0.22      
          scale(ideology) 0.01392  0.1180   -0.92  0.22 -0.22
Number of obs: 16841, groups:  isocntry, 28

Fixed effects:
                                                      Estimate Std. Error
(Intercept)                                           -0.63118    0.13411
scale(age)                                            -0.06620    0.04728
I(scale(age)^2)                                       -0.08304    0.02284
female1                                                0.40374    0.05622
occupationRetired                                     -0.13792    0.06342
occupationSelf employed                                0.14178    0.07322
occupationStudent                                      0.29189    0.09997
occupationUnemployed                                   0.09313    0.06756
religionMuslims                                       -0.54324    0.16224
religionNot religious                                  0.39073    0.05705
religionOrthodox Chrsitian                             0.05237    0.08811
religionOther religions                               -0.18230    0.09296
scale(religiosity_percent)                            -0.23696    0.09523
personal_satisSatisfied                                0.39932    0.05227
contact_lgbtiContact                                   0.90247    0.04243
scale(rain_ind)                                        0.21266    0.11379
self_determination1                                    0.52020    0.25144
scale(ideology)                                       -0.18644    0.02956
scale(gdp_pc)                                          0.20579    0.11594
religionMuslims:scale(religiosity_percent)            -0.21164    0.29125
religionNot religious:scale(religiosity_percent)       0.11296    0.04840
religionOrthodox Chrsitian:scale(religiosity_percent)  0.27646    0.07560
religionOther religions:scale(religiosity_percent)    -0.23650    0.07022
contact_lgbtiContact:scale(rain_ind)                   0.07158    0.04361
scale(ideology):scale(gdp_pc)                         -0.10888    0.03246
                                                      z value Pr(>|z|)    
(Intercept)                                            -4.707 2.52e-06 ***
scale(age)                                             -1.400 0.161470    
I(scale(age)^2)                                        -3.636 0.000277 ***
female1                                                 7.181 6.90e-13 ***
occupationRetired                                      -2.175 0.029664 *  
occupationSelf employed                                 1.936 0.052818 .  
occupationStudent                                       2.920 0.003503 ** 
occupationUnemployed                                    1.378 0.168101    
religionMuslims                                        -3.348 0.000813 ***
religionNot religious                                   6.849 7.45e-12 ***
religionOrthodox Chrsitian                              0.594 0.552231    
religionOther religions                                -1.961 0.049877 *  
scale(religiosity_percent)                             -2.488 0.012837 *  
personal_satisSatisfied                                 7.640 2.18e-14 ***
contact_lgbtiContact                                   21.269  < 2e-16 ***
scale(rain_ind)                                         1.869 0.061636 .  
self_determination1                                     2.069 0.038553 *  
scale(ideology)                                        -6.307 2.84e-10 ***
scale(gdp_pc)                                           1.775 0.075897 .  
religionMuslims:scale(religiosity_percent)             -0.727 0.467438    
religionNot religious:scale(religiosity_percent)        2.334 0.019613 *  
religionOrthodox Chrsitian:scale(religiosity_percent)   3.657 0.000255 ***
religionOther religions:scale(religiosity_percent)     -3.368 0.000757 ***
contact_lgbtiContact:scale(rain_ind)                    1.641 0.100752    
scale(ideology):scale(gdp_pc)                          -3.354 0.000796 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
