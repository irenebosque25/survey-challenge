...
western_northern <- c("AT", "BE", "DK", "FI", "FR", "DE", "IE", "IS", "LU", "NL", "NO", "SE", "CH", "UK", "ES", "PT", "IT", "GB")
eastern <- c("BG", "CZ", "EE", "HU", "LT", "LV", "PL", "RO", "RU", "SK", "SI", "HR", "UA", "GR", "CY")

p1 <- ggplot(final_data, aes(x = gdp_pc, y = rain_ind, text = isocntry, 
                             color = ifelse(isocntry %in% western_northern, "Western/Northern",
                                            ifelse(isocntry %in% eastern, "Eastern", NA)))) +
...
p2 <- ggplot(final_data, aes(x = religiosity_percent, y = rain_ind, text = isocntry,
                            color = ifelse(isocntry %in% western_northern, "Western/Northern",
                                            ifelse(isocntry %in% eastern, "Eastern", NA)))) +
  geom_point(size = 3, alpha = 0.8) + 
  theme_light(base_size = 14) +
